...
async function main() {
    ...
    // 监听 ContractDeployed 事件(Ganache中无法显示Event，还未找到原因)
    // 以下监听函数似乎不生效(如果是Ethers5版本，就可以生效，还未找到原因)
